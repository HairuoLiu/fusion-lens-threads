...
| 3 | `thread-type-dropdown.png` | ⬜ **You capture** | **The money shot.** Fusion 360 Thread dialog with the *Thread Type* dropdown open, showing **Camera Lens and Filter Threads** highlighted in the list. | ~1000 px wide |
...
| 7 | `fusion-thread-dialog.png` | ⬜ You capture | Full Thread dialog with **Modeled** checked, Thread Type = Camera Lens and Filter Threads, a Size + Designation chosen (e.g. `M42x1`), applied to a cylinder in the canvas. | ~1100 px wide |
