...
<p><strong>Install:</strong> after installing from the App Store, run the add-in once
(Tools &gt; Scripts and Add-Ins &gt; Add-Ins &gt; Run). It copies the XML into
Fusion's ThreadData folder. Restart Fusion 360.</p>
<p><strong>Uninstall:</strong> in Fusion 360, go to Tools &gt; Scripts and Add-Ins &gt;
Add-Ins tab, select the add-in, click <em>Unload</em>, then close Fusion. To fully
remove, delete the <code>LensSizeThreads.bundle</code> folder from your add-ins
directory and (optionally) <code>LensSizeThreads.xml</code> from every Fusion
ThreadData folder.</p>
<h2>Support</h2>
<p>Free and open-source. Report issues or ask questions at
<a href="https://github.com/HairuoLiu/fusion-lens-threads/issues">github.com/HairuoLiu/fusion-lens-threads/issues</a>.
No paid support is offered.</p>
<h2>License</h2>
