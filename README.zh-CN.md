...
在 Fusion 360 中，只要在「规格 (Designation)」下拉里选对应项即可——见[在 Fusion 360 中使用](#在-fusion-360-中使用)里的规格截图，两种螺距并列可见。
...
<p align="center">
  ...
  <br><em>已选中「Camera Lens and Filter Threads」的完整螺纹对话框，显示在圆柱体上生成建模螺纹。</em>
</p>
